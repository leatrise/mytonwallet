...
import {
  APP_NAME, IS_EXPLORER, IS_GRAM_WALLET, IS_PACKAGED_ELECTRON, IS_TON_BRAND,
  LANG_CACHE_NAME, LANG_LIST, NATIVE_BIOMETRICS_PROMPT_KEY,
} from '../config';
...
function processTranslation(
  ...
  const rawTemplate = typeof langString === 'string'
    ? langString
    : preferredPluralOption === 'value'
      ...
      : typeof langString === 'object'
        ...
        : undefined;
  const template = IS_GRAM_WALLET || IS_TON_BRAND
    ? rawTemplate
    : rawTemplate
      ?.replaceAll('My Wallets', '__MY_WALLETS__')
      .replaceAll('My Wallet Coin', '__MY_WALLET_COIN__')
      .replaceAll('My Wallet', APP_NAME)
      .replaceAll('__MY_WALLETS__', 'My Wallets')
      .replaceAll('__MY_WALLET_COIN__', 'My Wallet Coin');
